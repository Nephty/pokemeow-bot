...
# PATH
# enter the location of the script here (for example : /home/user/scripts or C:\\User\\scripts)
# don't put any / or \\ at the end
path = ""
...
with open(f"{path}\\pokebot_total.txt", "w") as f:
    f.truncate()
